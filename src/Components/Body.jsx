...
{/* order property make us in which side or which property do u assign */}
      <div className="lg:flex-1 lg:order-1"> 
        <h1 className="text-5xl font-bold font-playfair leading-tight">Host your website in less than 5 minutes</h1>
        <p className="font-lato text-gray-400 py-3">With Hoster , get your website up and running in no less than 5 minutes with the most competitive pricing packages available online.</p>
        ...
        <div className="flex gap-2">
          ...
          <p className="font-lato text-gray-400 py-2">No spam, ever, Unsubscribe anytime</p>
        </div>
      </div>
    </div>
  )
